...
uniform sampler2D uDisplacement;\r
...
void main() {\r
  vec4 displacement = texture2D(uDisplacement, vUv);\r
  ...
  float noiseValue = 1.0 - pow(sin(cnoise(uv +uTime * 0.05) * sin(uTime*0.1)*10.0), 0.5)+0.5;\r
  
    \r
    noiseValue = clamp(noiseValue, 0.0, 5.0);

    vec3 blackColor = vec3(0.0);\r
    vec3 whiteColor = vec3(1.0);\r
...
//# sourceMappingURL=index-cdc24bdb.js.map
